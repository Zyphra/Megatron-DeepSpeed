...
if [ "${USE_INTERNAL_DATA}" = "true" ]; then
    ...
    VOCAB_PATH=/datasets/SlimPajama-627B_megatron/gpt-neox-20b-tokenizer/vocab.json
    MERGE_PATH=/datasets/SlimPajama-627B_megatron/gpt-neox-20b-tokenizer/merges.txt
    # Public the Pile dataset, can be downloaded at https://mystic.the-eye.eu/public/AI/pile_neox/
    DATA_BLEND=/datasets/SlimPajama-627B_megatron/gpt-neox-20b-tokenizer/train_text_document
fi
###############################################################################
data_options=" \
